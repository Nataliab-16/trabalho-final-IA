...
ARQUIVO_VIDEO = 'rastreio-pessoas/video.mp4'
...
def main():
    ...
    while True:
        if not pausado:
            ...
            numero_assentos_totais = 8
            numero_assentos_livres = numero_assentos_totais - numero_pessoas 
            ...
            cv2.putText(frame, f"Numero de assentos livres: {numero_assentos_livres}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
